...
class UdiConfig {
    ...
    public static $DEFAULTS = array(
           'ad' => array(
                    ...
                    'groups_enabled' => null,
                    'mappings' => 'mlepSmsPersonId(mlepSmsPersonId);mlepStudentNSN(mlepStudentNSN);mlepUsername(mlepUsername,sAMAccountName,uid);mlepFirstAttending(mlepFirstAttending);mlepLastAttendance(mlepLastAttendance);mlepFirstName(mlepFirstName,givenName);mlepLastName(mlepLastName,sn);mlepPreferredName(mlepPreferredName,displayName);mlepRole(mlepRole);mlepAssociatedNSN(mlepAssociatedNSN);mlepEmail(mlepEmail,mail);mlepOrganisation(mlepOrganisation);mlepHomeGroup(mlepHomeGroup);mlepDOB(mlepDOB);mlepGender(mlepGender)',
                    'group_mappings' => '',
                    'container_mappings' => '',
                    'group_attr' => 'member',
                    'create_in' => '',
