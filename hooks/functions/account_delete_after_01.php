<?php
/**
 * An example of an account delete callback
 *
...
/**
 * The account_delete_after function is called from within the udi_import Processor class
 * to allow access to each account after it has been deleted
 *
...
function account_delete_after_01() {
    global $request, $account_delete_after_logging;
