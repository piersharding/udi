<?php
/**
 * An example of an account deactivate callback
 *
...
/**
 * The account_deactivate_after function is called from within the udi_import Processor class
 * to allow access to each account after it has been deactivated
 *
...
function account_deactivate_after_01() {
    global $request, $account_deactivate_after_logging;
